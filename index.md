...
You may ask what data is associated with your Discord account or request its deletion by emailing **mahryct123@gmail.com** and including your Discord user ID. We may need to verify the request before acting on it.

## Changes to this policy

This policy may be updated when the Bot’s functionality or data practices change. The effective date above will be updated when changes are published.
